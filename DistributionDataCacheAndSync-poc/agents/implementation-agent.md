...
- Reference the requirement it fulfills (FR-xxx)
...
| ID | Task | Size | Dependencies | Requirements |
|----|------|------|--------------|--------------|
| T-003 | Implement Entity class | M | T-002 | FR-001 |

### Phase 3: Data Access
| ID | Task | Size | Dependencies | Requirements |
|----|------|------|--------------|--------------|
| T-004 | Create database schema | M | T-002 | - |
| T-005 | Implement repository | M | T-003, T-004 | FR-001 |

### Phase 4: Business Logic
| ID | Task | Size | Dependencies | Requirements |
|----|------|------|--------------|--------------|
| T-006 | Implement service layer | L | T-005 | FR-001, FR-002 |

### Phase 5: API Layer
| ID | Task | Size | Dependencies | Requirements |
|----|------|------|--------------|--------------|
| T-007 | Implement REST endpoints | L | T-006 | FR-001 |
...
- [ ] FR-001: Implemented in [file/function]
- [ ] FR-002: Implemented in [file/function]
...
/// Design Reference: docs/design/detailed-design.md#section
/// </remarks>
```

### Traceability Comments
```csharp
// REQ: FR-001 - User can create a resource
